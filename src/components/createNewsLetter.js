    ...
    return <>
        ...
        <div className="flex" style={{ 'padding': '100px' }}>
            ...
            <div className="adminBody">
                <h3 id="create">Create NewsLetter</h3>
                <div className="editform">
                    <h3>Details</h3>
                    <form method="POST" action={mainUrl + "/newsletter"}>
                        ...
                        {/* <input type="text" placeholder="News Content" name="news_body" required /> */}
                        <textarea style={{ color: "white", background: 'black' }} placeholder="News Content" name="news_body" required />
