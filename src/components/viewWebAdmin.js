                    ...
                    <div className="editing"  >
                        <div id="myeditUser" className="editform" ref={showEdit}>
                            <div>
                                ...
                                <input type="password" placeholder="New Password" name="password" id="password" value={passwd} onChange={(e) => setPassword(e.target.value)} />
...
export default ViewWebsiteAdmin;