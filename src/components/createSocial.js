    ...
    return <>
        ...
        <div className="flex" style={{ 'padding': '100px' }}>
            ...
            <div className="adminBody">
                <h3 id="create">Create Social Media Accounts</h3>
                <div className="editform">
                    <h3>Details</h3>
                    <form method="POST" action={mainUrl + "/socialmedias"}>
                        ...
                        <input style={{ color: "white", background: 'black' }} type="text" placeholder="IG URL" name="igUrl" required />
                        <input style={{ color: "white", background: 'black' }} type="text" placeholder="FB URL" name="fbUrl" required />
                        <input style={{ color: "white", background: 'black' }} type="text" placeholder="Twitter URL" name="twitterUrl" required />
