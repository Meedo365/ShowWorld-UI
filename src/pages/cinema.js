            ...
            <div>
                ...
                <div className="flex">
                    <div className="flex box">
                        <Link to="/createcinema" style={{ 'color': 'black', 'textDecoration': 'none' }}>
                            <h5> Create A New Cinema</h5>
                        </Link>
                    </div>

                    <div className="flex box">
                        <Link to="/viewcinemas" style={{ 'color': 'black', 'textDecoration': 'none' }}>
                            <h5> View All Cinemas</h5>
                        </Link>
                    </div>
                </div>
            </div>
