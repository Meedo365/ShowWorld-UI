            ...
            <div>
                ...
                <div className="flex">
                    <div className="flex box">
                        <Link to="/createmovieschedule" style={{ 'color': 'black', 'textDecoration': 'none' }}>
                            <h5> Create Movie Schedule</h5>
                        </Link>
                    </div>

                    <div className="flex box">
                        <Link to="/viewmovieschedule" style={{ 'color': 'black', 'textDecoration': 'none' }}>
                            <h5> View All Movie Schedules</h5>
                        </Link>
                    </div>
                </div>
            </div>
