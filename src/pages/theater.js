        ...
        <div className="flex" >
            ...
            <div className="flex">
                <div className="flex box">
                    <Link to="/createtheater" style={{ 'color': 'black', 'textDecoration': 'none' }}>
                        <h5> Create New Theater</h5>
                    </Link>
                </div>
                <div>
                    <div>
                    ...
                    <div className="flex box">
                        <Link to="/viewtheaters" style={{ 'color': 'black', 'textDecoration': 'none' }}>
                            <h5> View All Theaters</h5>
                        </Link>
                    </div>
                </div>
            </div>
